...
--
-- Host: 10.1.5.31    Database: mifosplatform-tenants
-- ------------------------------------------------------
...
INSERT INTO `schema_version` VALUES (1,1,'1','mifos-platform-shared-tenants','SQL','V1__mifos-platform-shared-tenants.sql',-486745552,'root','2014-10-12 22:13:50',896,1),(2,2,'2','externalize-connection-properties','SQL','V2__externalize-connection-properties.sql',210473669,'root','2014-10-12 22:13:51',661,1),(3,3,'3','deadlock-retry-properties','SQL','V3__deadlock-retry-properties.sql',1523909379,'dbtomcat','2019-02-07 17:00:48',25,1),(4,4,'4','introduced oltpId reportId columns and tenants server connection table','SQL','V4__introduced_oltpId_reportId_columns_and_tenants_server_connection_table.sql',417291024,'dbtomcat','2019-02-07 17:00:48',51,1);
...
INSERT INTO `tenant_server_connections` VALUES (1,'IpRDS','mifostenant-default','3306','UserRDS','SenhaRDS',1,5,30000,1,60,1,50,1,40,20,10,60,34000,60000,0,1);
...
INSERT INTO `tenants` VALUES (1,'default','default','Asia/Kolkata',NULL,NULL,NULL,NULL,1,1);
...
-- Dump completed on 2019-02-08  9:36:02
